 ...
 <div class="absolute bottom-0 left-2 right-2 block print:hidden">
     <div class="container mx-auto">
         ...
         <footer
             ...
             <?php echo $dernek_adi; ?>. Tüm hakları saklıdır.
             <span class="float-right hidden text-slate-600 dark:text-slate-400 md:inline-block">Yazılım Geliştiricisi
                 <i class="ti ti-heart text-red-500"></i>
                 <a href="mailto:hi@alicangunduz.dev"> Ali Can Gündüz </a></span>
         </footer>
         <!-- end Footer -->
     </div>
 </div>