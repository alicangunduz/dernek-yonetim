                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="/functions/uye-guncelle.php" method="POST">
                                ...
                                <div class="grid xl:grid-cols-2 xl:gap-6">
                                    ...
                                    <div class="relative z-0 mb-6 w-full group">
                                        ...
                                        <select id="Uyelik_Durumu" name="Uyelik_Durumu" for="Uyelik_Durumu"
                                            ...
                                            <option value="Aktif"
                                                <?php if($uyelik_durumu == "Aktif"){echo "selected";}?>>
                                                Aktif</option>
                                            <option value="Pasif"
                                                <?php if($uyelik_durumu == "Pasif"){echo "selected";}?>>
                                                Pasif</option>
                                            <option value="Vefat"
                                                <?php if($uyelik_durumu == "Vefat"){echo "selected";}?>>
                                                Vefat</option>
                                            <option value="İhraç"
                                                <?php if($uyelik_durumu == "İhraç"){echo "selected";}?>>
                                                İhraç</option>
                                            <option value="İstifa"
                                                <?php if($uyelik_durumu == "İstifa"){echo "selected";}?>>
                                                İstifa</option>
                                        </select>
                                    </div>
                                ...
                                <button type="submit"
                                    class="btn bg-blue-500 text-white hover:bg-blue-600">Güncelle</button>
                            </form>

                            <br>
                            <button onclick="uyeSil()"
                                class="focus:outline-none text-white bg-red-500 hover:bg-red-600 focus:ring-4 focus:ring-red-300 font-medium rounded text-sm px-3 py-2 mr-2 mb-2 dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-800">Sil
                                (Dikkat Bu
                                işlem geri alınamaz)</button>
                            ...
                            <table class="table-auto w-full">
                                <thead>
                                    <tr class="bg-primary-500 text-center">
                                        <th
                                            class="text-sm font-medium text-white px-3 py-3 border-l border-transparent">
                                            Tarih
                                        </th>
